 ...
 */
public class UpdateGlobalPheromoneTimeAndProfit<C, E extends Environment> extends DaemonAction<C, E> {

    public UpdateGlobalPheromoneTimeAndProfit() {
        super(DaemonActionType.AFTER_ITERATION_CONSTRUCTION);
    }

    private static Logger logger = Logger.getLogger(UpdateGlobalPheromoneTimeAndProfit.class.getName());
    ...
    protected double getPheromoneDeposit(Ant<C, E> ant,
        ...
        //sarah
        //TODO change this so that pheromone is profit / tour time?
    ...
    public String toString() {
        return "UpdateGlobalPheromoneTimeAndProfit{}";
    }
